    ...
    'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-neutral-300',
    {
        variants: {
            variant: {
                ...
                primary: 'bg-primary text-neutral-50 shadow-sm hover:bg-primary/90 dark:bg-indigo-900 dark:text-neutral-50 dark:hover:bg-indigo-900/90',
                success: 'bg-success text-neutral-50 shadow-sm hover:bg-success/90 dark:bg-green-900 dark:text-neutral-50 dark:hover:bg-green-900/90',
                warning: 'bg-warning text-neutral-50 shadow-sm hover:bg-warning/90 dark:bg-yellow-400 dark:text-neutral-900 dark:hover:bg-yellow-400/90',
                info: 'bg-info text-neutral-50 shadow-sm hover:bg-info/90 dark:bg-blue-900 dark:text-neutral-50 dark:hover:bg-blue-900/90',
